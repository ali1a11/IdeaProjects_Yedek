...
package deneme.MOOC_11.flightControl;

import deneme.MOOC_11.flightControl.domain.Airplane;
import deneme.MOOC_11.flightControl.domain.Flight;
import deneme.MOOC_11.flightControl.logic.FlightControl;
...
public class TextUI {
    ...
    private void startAssetControl() {
        ...
        while (true) {
            ...
            if (answer.equals("1")) {
                addAirplane(); //addAirplane(scanner);
            } else if (answer.equals("2")) {
                addFlight(); //addFlight(scanner);
