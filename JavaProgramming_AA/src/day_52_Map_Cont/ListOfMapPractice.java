...
public class ListOfMapPractice {
    public static void main(String[] args) {
        ...
        // Array or collection can be used
        ...
        System.out.println("the names of all employees:");

        for (Map<String, String> eachScrumTeam : scrumTeams) {

            for (String key : eachScrumTeam.keySet()) {
                System.out.println(key);
            }
        }

        System.out.println("the names of all employees and job titles:");
        ...
        System.out.println("the names of all scrum masters");
        for (Map<String, String> eachScrumTeam : scrumTeams) {
/*
...
*/
        ...
        System.out.println();
        System.out.println("---------------------------");
        System.out.println("the names of all Developers");
        for (Map<String, String> eachScrumTeam : scrumTeams) {
