...
public class Car {
    ...
    /* // autoPilot() is not common among subclasses. Therefore we do not use this method in parent class
    // parent class should only contain common features of subclasses
